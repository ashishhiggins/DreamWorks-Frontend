...
//     // Make a post api req to send propertyFilter and receive the data from api in propertyData
//   };
...
//     <input className='border-2 border-gray-300 p-2 w-1/3 rounded-md mx-2' type='text2' placeholder='Type' name='ptype' onChange={handleChange} />
//   </div>
